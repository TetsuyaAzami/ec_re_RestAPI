...
INSERT INTO users(name, email, password, zipcode, address, telephone, role) VALUES ('user1','user1@example.com','password1','111-1111','住所1', '111-1111-1111',1),('user2','user2@example.com','password2','222-2222','住所2', '222-2222-2222',2);
